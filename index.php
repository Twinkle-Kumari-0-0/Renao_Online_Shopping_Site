...
<head>
	<title>Ré nao: Online Shopping</title>
	<meta charset="UTF-8">
	<link rel="icon" href="image/Picture16.png">
...
<div class="inner_cont">
		...
		<div class="row">
   			<div class="col-sm-3">
     			<img src="image/Picture13.png"><br>
    		</div>
   			<div class="col-sm-3">
      			<img src="image/Picture12.png"><br>
    		</div>
    		<div class="col-sm-3">
     			 <img src="image/Picture14.png"><br>
    		</div>
    		<div class="col-sm-3">
     			 <img src="image/Picture15.png"><br>
    		</div>
 		 </div>
 		 <br>
	</div>
    ...
    <div class="owl-carousel">
    	<div><img src="image/15.webp"></div>
		<div> <img src="image/101.jpg"> </div>
		<div><img src="image/3.jpg"></div>
		<div> <img src="image/399.avif"> </div>
		<div> <img src="image/b.webp"> </div>
	</div>
	...
	<div class="container">
		<div class="row">
   			<div class="col-sm-4">
     			<img src="image/m1.png" style="width: 100%; height: auto"><br>
    		</div>
   			<div class="col-sm-4">
      			<img src="image/m2.webp" style="width: 100%; height: auto"><br>
    		</div>
    		<div class="col-sm-4">
     			 <img src="image/m3.webp" style="width: 100%; height: auto"><br>
    		</div>
 		 </div>
 		 <br><br>
 		 <div class="row">
   			<div class="col-sm-4">
     			<img src="image/m4.webp" style="width: 100%; height: auto"><br>
    		</div>
   			<div class="col-sm-4">
      			<img src="image/m5.webp" style="width: 100%; height: auto"><br>
    		</div>
    		<div class="col-sm-4">
     			 <img src="image/m6.webp" style="width: 100%; height: auto"><br>
    		</div>
 		 </div>
	</div>
	<br><br><br>
...
<div class="cat_cont">
	<div class="inner_cat_cont">
		...
		<div class="container">
			<div class="row">
  				<div class="col-sm-6"><div class="crd"><div style="max-width: 50%; min-width: 50%; display: block; min-height: 400px; background:url(image/s1.webp) 50% 50%; background-size: cover; float: left;"></div><div style="max-width: 50%; min-width: 50%;display: block; background-color: #fff; min-height: 400px; float: right; padding-left: 20px; padding-top: 20px"><div style="font-family: 'Roboto', sans-serif; font-size: 12pt; font-weight: 900; color: rgba(0,0,0,0.8);">Men's Popular</div>
  				<br>
...
<div class="inner_cont">
	...
	<div class="small_title">Ré nao: The trailblazer of online fashion destination!</div>
	<div class="small_cont">The leader in fashion online shopping has stamped its mark throughout India. With an aim to redefine the fashion arena in India, Ré nao has everything to offer, ranging from all kinds of men’s and women’s apparels to accessories. Featuring some of the best deals in the realm of fashion accessories and trending gears, you may attractive discounts and shop till you drop at end of the season sales. To make shopping convenient, Ré nao provides easy payment facility through Cash on Delivery, Card on Delivery, and similar payment options. And to get your purchased apparel on time, it boasts an efficient network of delivery. You can also easily make a wishlist and shortlist items for future puchases. Whether it is clothing, footwear, jewelry, accessories and cosmetics, we showcase the most elite brands in the world. Now, if you did not like the purchased product, then shop something else through our easy return or exchange policy. Explore the latest collections of top brands like United Colors of Benetton, Arrow, Esprit, French Connection, Adidas, Reebok, Nike, Clarks, Burberry, Calvin Klein and many others.</div>
	<br>

	<div class="small_title">Avail added online shopping benefits</div>
	<div class="small_cont">With a variety of products and their information available in the most user-friendly way on Ré nao, you get a chance to analyze the product you want to buy according to your terms. You can shop in complete privacy and get easy replacement and returns as well. You can choose your desired product and order it on Ré nao. Our team will leave no stone unturned to deliver it right at your doorstep anywhere in India at the promised time. You just need to pay for the product, while we ensure free shipping on almost everything. To offer you a safe and risk-free online shopping experience, we have COD facility as well. Now, you can buy gifts for your loved ones and avail our special gift-wrap facility at a nominal cost on Ré nao.</div>

	<br>

	<div class="small_title">Ré_nao.com: the 24 x7 one stop Fashion & Lifestyle store for everyone</div>
	<div class="small_cont">We, at Ré_nao, have all that you need to spruce up your fashion quotient. From an extensive range of men’s shirts, western dresses for women, funky clothes for kids and matching footwear, sports shoes and accessories for everyone, we cater to a diversity of choices of online shoppers in India under one umbrella. So, don’t lose out on your chance to buy your desired piece of apparel and avail our attractive discounts!</div>
